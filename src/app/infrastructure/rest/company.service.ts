...
export class CompanyService {
  ...
  search(searchFilter: any): Observable<PagedResult<CompanyNoAdmin>> {
    ...
    const countryQuery = searchFilter.country != "" ? `country=${searchFilter.country}` : "";
    const cityQuery = searchFilter.city != "" ? `city=${searchFilter.city}` : "";
    ...
    if (cityQuery != "") query = query != "" ? `${query}&${cityQuery}` : cityQuery;
  ...
  findAllByEquipmentId(searchFilter: any, equipmentId: number|null): Observable<PagedResult<CompanyNoAdmin>>{
